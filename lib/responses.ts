...
export const STRATEGIC_RESPONSES: StrategicResponse[] = [
  // BASIC PROJECT DESCRIPTION PIVOT TO RFP
  {
    ...
    response: "Sounds like a great starting point! If you'd like, I can help you build a proper RFP (Request for Proposal) that outlines your goals, timeline, style preferences, and budget. That way, our team can hit the ground running with ideas tailored to your brand. Want to go through that together now?",
